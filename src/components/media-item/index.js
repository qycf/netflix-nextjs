...
export default function MediaItem(Prop) {
  {
    ...
    const onMouseLeave = (e) => {
      // 清除定时器，防止鼠标离开后仍执行onMouseEnter的逻辑
      if (timerId) {
    ...
    return (
      ...
      >
        <div
          className="z-[1] h-[131px]"
        // className="z-[1] w-[233px] h-[131px]"
        >
          <img src={media.vodPic} className="w-full h-full object-cover" />
        </div>
            ...
            <div className="">
              <div>
                <div
                  ...
                  className={`relative w-[270px] h-auto`}
                  style={{
                ...
                >
                  <MediaPlayer
                    title="player"
                    src={vodPlayUrlChecker(media.vodPlayUrl)}
                ...
                <img
                  src={media?.vodPic}
                  className={`absolute inset-0 w-[233px] h-[131px] ${!video ? "opacity-100" : "opacity-0 pointer-events-none"
                    } transition-opacity duration-300 object-cover `}
                />
              </div>
              <div
                className="px-4 pt-2 pb-[0.1rem] bg-[#181818]"
                style={{
              ...
              >
                ...
                <div className="my-3 flex flex-col">
                  ...
                  <span className="text-[10px] text-[#fff] font-medium">
                    {media.vodActor}
                  </span>
                </div>
                {/* <div>tags</div> */}
...
export const VolumeHigh = ({ onClick }) => (
  <div
    onClick={onClick}
    className="z-[3] absolute right-2 bottom-2 border-2 hover:text-white text-[#ffffff80] hover:border-white border-[#ffffff30] p-1.5 rounded-full"
  >
